# Synth 216 Nudging walking wild

**Game name:** Synth 216 Nudging walking wild

| Field | Value |
|---|---|
| **Internal name** | UQ-lock_respin-nudging-wild |
| **Genre** | nudging-wild |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: Walking wild nudges 1 reel per spin; retrigger resets position.
