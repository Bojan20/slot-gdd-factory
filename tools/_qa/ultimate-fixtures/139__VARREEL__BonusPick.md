# Synth 139 Pick-me bonus

**Game name:** Synth 139 Pick-me bonus

| Field | Value |
|---|---|
| **Internal name** | UQ-variable_reel-bonus-pick |
| **Genre** | bonus-pick |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: Trigger opens a pick-from-grid bonus; each reveal a multiplier.
