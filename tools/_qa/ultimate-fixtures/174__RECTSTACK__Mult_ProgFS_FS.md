# Synth 174 BG + FS multiplier (FS progressive)

**Game name:** Synth 174 BG + FS multiplier (FS progressive)

| Field | Value |
|---|---|
| **Internal name** | UQ-rectangular_stacked_scatter-mult-bg-and-fs |
| **Genre** | mult-bg-and-fs |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: Both base-game and Free Spins carry a multiplier; FS multiplier is progressive.
