# UQ Fixture 226 · Bonus Buy — three tiers w/ FS multiplier · variable_reel

| Field | Value |
|---|---|
| **Internal name** | UQ-variable_reel-bonus-buy-multi-tier |
| **Genre** | bonus-buy-multi-tier |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: Standard / Premium / Super buy tiers; each plants explicit scatter counts and carries an FS multiplier.
