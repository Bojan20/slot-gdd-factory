# Synth 089 Lightning multipliers

**Game name:** Synth 089 Lightning multipliers

| Field | Value |
|---|---|
| **Internal name** | UQ-rectangular_stacked_scatter-lightning |
| **Genre** | lightning |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: Random multiplier symbols zap during spin; sum of all hits.
