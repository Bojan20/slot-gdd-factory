# Synth 256 Win cap (high ceiling 25000×)

**Game name:** Synth 256 Win cap (high ceiling 25000×)

| Field | Value |
|---|---|
| **Internal name** | UQ-rectangular_stacked_scatter-win-cap-high |
| **Genre** | win-cap-high |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: Hard win cap at 25000× bet — high enough that cap rarely fires.
