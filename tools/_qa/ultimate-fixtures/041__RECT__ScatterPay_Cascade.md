# Synth 041 Pay-anywhere scatter

**Game name:** Synth 041 Pay-anywhere scatter

| Field | Value |
|---|---|
| **Internal name** | UQ-rectangular-pay-anywhere |
| **Genre** | pay-anywhere |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: 8+ matching symbols anywhere on grid pay; cascade after.
