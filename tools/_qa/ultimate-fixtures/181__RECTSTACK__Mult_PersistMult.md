# Synth 181 Persistent base-game multiplier

**Game name:** Synth 181 Persistent base-game multiplier

| Field | Value |
|---|---|
| **Internal name** | UQ-rectangular_stacked_scatter-persistent-mult-bg |
