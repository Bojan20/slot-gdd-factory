# Synth 190 Lightning multiplier (FS only)

**Game name:** Synth 190 Lightning multiplier (FS only)

| Field | Value |
|---|---|
| **Internal name** | UQ-rectangular_stacked_scatter-lightning-fs |
| **Genre** | lightning-fs |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: Lightning multiplier symbols zap only during Free Spins; base-game flat.
