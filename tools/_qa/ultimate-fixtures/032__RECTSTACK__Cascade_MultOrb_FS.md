# Synth 032 Tumble + multiplier orb

**Game name:** Synth 032 Tumble + multiplier orb

| Field | Value |
|---|---|
| **Internal name** | UQ-rectangular_stacked_scatter-tumble-multiplier |
| **Genre** | tumble-multiplier |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: Cascade with multiplier-orb symbols that accumulate across the chain.
