# Synth 067 Mystery symbol reveal

**Game name:** Synth 067 Mystery symbol reveal

| Field | Value |
|---|---|
| **Internal name** | UQ-variable_reel-mystery-symbol |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: Mystery icons land then reveal a single matching paying symbol.
