# Synth 128 Ante Bet (double scatter chance)

**Game name:** Synth 128 Ante Bet (double scatter chance)

| Field | Value |
|---|---|
| **Internal name** | UQ-rectangular_stacked_scatter-ante-bet |
| **Genre** | ante-bet |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: 25% extra cost boosts scatter trigger chance.
