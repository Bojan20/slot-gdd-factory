# Synth 157 Base-game multiplier only

**Game name:** Synth 157 Base-game multiplier only

| Field | Value |
|---|---|
| **Internal name** | UQ-rectangular_stacked_scatter-mult-bg-only |
| **Genre** | mult-bg-only |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: Base-game multiplier only — Free Spins phase is flat 1×.
