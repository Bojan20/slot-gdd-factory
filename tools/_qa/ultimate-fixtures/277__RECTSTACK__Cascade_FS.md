# Synth 277 Cascade in BG carries into Free Spins

**Game name:** Synth 277 Cascade in BG carries into Free Spins

| Field | Value |
|---|---|
| **Internal name** | UQ-rectangular_stacked_scatter-cascade-then-fs |
