# Synth 008 Cluster pays cascade

**Game name:** Synth 008 Cluster pays cascade

| Field | Value |
|---|---|
| **Internal name** | UQ-megaclusters-cluster-pays |
| **Genre** | cluster-pays |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: Cluster of 4+ adjacent symbols pays; cluster tumbles trigger a fresh evaluation.
