# Synth 047 Sticky wild Free Spins

**Game name:** Synth 047 Sticky wild Free Spins

| Field | Value |
|---|---|
| **Internal name** | UQ-rectangular_stacked_scatter-sticky-wild-fs |
| **Genre** | sticky-wild-fs |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: During FS, wilds stick across the remaining spins; standard scatter trigger.
