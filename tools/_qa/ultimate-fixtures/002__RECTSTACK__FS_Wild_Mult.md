# Synth 002 Classic Vegas line-pay

**Game name:** Synth 002 Classic Vegas line-pay

| Field | Value |
|---|---|
| **Internal name** | UQ-rectangular_stacked_scatter-classic-lines |
| **Genre** | classic-lines |
...
## Notes
Synthetic fixture for Wave UQ Ultimate QA. Pattern: Fixed paylines + scatter-triggered Free Spins + simple wilds. Industry baseline 5×3.
