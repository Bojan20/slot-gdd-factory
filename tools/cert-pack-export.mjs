...
export function buildCertPack(opts = {}) {
  ...
  /* 4. rng_sample.bin — 90B (10 KB compressed for ZIP size). 9 megabits =
   * 90 * 1024 random bytes. Used by regulator NIST SP800-22 test suite. */
  const rngSample = randomBytes(90 * 1024);
