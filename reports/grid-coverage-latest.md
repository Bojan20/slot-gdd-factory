...
**Generated**: 2026-06-04T17:01:28.850Z
...
|--:|---|---|---|---|--:|--:|--:|--:|--:|:--:|
| 1 | `01_rectangular_5x3_GAME_GDD.md` | rectangular | rectangular | 5×3 | 15 | 5 | 0 | 100% | 10.8 | ✅ |
| 2 | `02_rectangular_6x4_GAME_GDD.md` | rectangular | rectangular | 6×4 | 24 | 6 | 0 | 100% | 6.6 | ✅ |
| 3 | `03_cluster_7x7_GAME_GDD.md` | cluster | cluster | 7×7 | 49 | 7 | 0 | 100% | 0.4 | ✅ |
...
| 6 | `06_hexagonal_GAME_GDD.md` | hexagonal | hexagonal | 7×7 | 37 | 7 | 0 | 100% | 0.7 | ✅ |
| 7 | `07_diamond_GAME_GDD.md` | diamond | diamond | 5×5 | 19 | 5 | 0 | 100% | 0.3 | ✅ |
| 8 | `08_pyramid_GAME_GDD.md` | pyramid | pyramid | 5×5 | 13 | 5 | 0 | 100% | 0.2 | ✅ |
| 9 | `09_cross_GAME_GDD.md` | cross | cross | 5×5 | 21 | 5 | 0 | 100% | 0.4 | ✅ |
| 10 | `10_lshape_GAME_GDD.md` | l_shape | l_shape | 5×5 | 21 | 5 | 0 | 100% | 0.4 | ✅ |
...
| 15 | `15_slingo_GAME_GDD.md` | slingo | slingo | 5×5 | 25 | 5 | 1 | 100% | 0.5 | ✅ |
| 16 | `16_plinko_GAME_GDD.md` | plinko | plinko | 17×16 | 136 | 16 | 0 | 100% | 0.4 | ✅ |
| 17 | `17_crash_GAME_GDD.md` | crash | crash | 1×1 | 1 | 1 | 0 | 100% | 0.4 | ✅ |
| 18 | `18_wheel_GAME_GDD.md` | wheel | wheel | 1×24 | 24 | 1 | 0 | 100% | 0.3 | ✅ |
| 19 | `19_lock_respin_GAME_GDD.md` | lock_respin | lock_respin | 5×4 | 20 | 5 | 0 | 100% | 0.2 | ✅ |
