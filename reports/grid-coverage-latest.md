...
**Generated**: 2026-06-04T02:36:28.330Z
...
|--:|---|---|---|---|--:|--:|--:|--:|--:|:--:|
| 1 | `01_rectangular_5x3_GAME_GDD.md` | rectangular | rectangular | 5×3 | 15 | 5 | 0 | 100% | 10.4 | ✅ |
| 2 | `02_rectangular_6x4_GAME_GDD.md` | rectangular | rectangular | 6×4 | 24 | 6 | 0 | 100% | 7.3 | ✅ |
| 3 | `03_cluster_7x7_GAME_GDD.md` | cluster | cluster | 7×7 | 49 | 7 | 0 | 100% | 0.4 | ✅ |
| 4 | `04_variable_reel_GAME_GDD.md` | variable_reel | variable_reel | 6×7 | 28 | 6 | 0 | 100% | 1.5 | ✅ |
| 5 | `05_megaclusters_GAME_GDD.md` | megaclusters | megaclusters | 4×4 | 16 | 4 | 0 | 100% | 0.3 | ✅ |
| 6 | `06_hexagonal_GAME_GDD.md` | hexagonal | hexagonal | 7×7 | 37 | 7 | 0 | 100% | 0.4 | ✅ |
| 7 | `07_diamond_GAME_GDD.md` | diamond | diamond | 5×5 | 19 | 5 | 0 | 100% | 0.4 | ✅ |
...
| 11 | `11_radial_GAME_GDD.md` | radial | radial | 8×1 | 8 | 1 | 0 | 100% | 0.1 | ✅ |
...
| 16 | `16_plinko_GAME_GDD.md` | plinko | plinko | 17×16 | 136 | 16 | 0 | 100% | 0.3 | ✅ |
| 17 | `17_crash_GAME_GDD.md` | crash | crash | 1×1 | 1 | 1 | 0 | 100% | 0.3 | ✅ |
