...
export function emitMultiplierLadderMarkup(cfg = defaultConfig()) {
  ...
  return tagBlockMarkup(`<div id="multLadder" class="mult-ladder" role="status" aria-live="polite" aria-label="Multiplier ladder" data-i18n-aria="multiplierLadder.0" data-i18n-aria-fallback="Multiplier ladder" data-dynamic-aria="true" data-visible="false" data-tier="${cfg.startTier}">${label}</div>`, 'multiplierLadder');
}
