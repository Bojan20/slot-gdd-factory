...
| Surface | String |
|---|---|
| Game title display | Game-ROZ3 5x3 |
...
| Source par sheet | `PAR_Sheets_FortKnoxWolfRun.xlsx` |
| Par sheet SHA-256 | `5d3e59036cc5e8fab25e20c7ae5659c96cd455c365c82c4ad2f2a06c6fddf059` |
| Model path | `dist/par-sheet-real-games/fort-knox-wolf-run/model.json` |
...
```json
{
  ...
  "_derivedBy": {
    ...
    "rtp": "par-sheet:PAR_001!G13",
    "winCap": "absent",
    "reelStrips": "par-sheet:PAR_001",
    "paytable": "par-sheet:PAR_001@row65:combinations"
  }
}
```
