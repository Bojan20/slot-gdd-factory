...
| Surface | String |
|---|---|
| Game title display | Game-KDSV 5x3 |
...
| Source par sheet | `PARSheets_SkeletonKey.xlsx` |
| Par sheet SHA-256 | `78861e8af6bffa89bcce2fbaff70b237b629e45148eccbbd6f640f6db0f35389` |
| Model path | `dist/par-sheet-real-games/skeleton-key/model.json` |
...
```json
{
  ...
  "_derivedBy": {
    ...
    "rtp": "par-sheet:PAR-Base-001!O1",
    "winCap": "absent",
    "reelStrips": "par-sheet:PAR-Base-001",
    "paytable": "par-sheet:PAR-Base-001@row25:combinations"
  }
}
```
