# Game-DTTD 5x3 — Game Design Document (Synthetic, par-sheet-derived)

> **Document type**: Synthetic Game GDD (auto-generated from par sheet)
> **Source**: par-sheet-autonomous-ingest (PAR-3)
> **Pair**: math sourced from `dist/par-sheet-real-games/book-of-unseen-bonus-buy/model.json`
> **Audience**: factory pipeline (UX wrap → playable slot.html)
> **Status**: synthetic — vendor-neutral wrapper, real par sheet math
> **Generated**: 2026-06-26
> **Par sheet**: `ParSheets_BookOfUnseen_BonusBuy.xlsx`
> **Par sheet SHA-256**: `92a9f9a909fd421f…`
...
| Surface | String |
|---|---|
| Game title display | Game-DTTD 5x3 |
...
| Source par sheet | `ParSheets_BookOfUnseen_BonusBuy.xlsx` |
| Par sheet SHA-256 | `92a9f9a909fd421f767be9441d9819faf43cac9c33d89a4326cac2ac14d76e99` |
| Model path | `dist/par-sheet-real-games/book-of-unseen-bonus-buy/model.json` |
