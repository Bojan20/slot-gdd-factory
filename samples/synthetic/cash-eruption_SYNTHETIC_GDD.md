...
8 fixed lines, generated by the platform's standard
...
| Surface | String |
|---|---|
| Game title display | Game-RLVA 5x3 |
...
| Source par sheet | `ParSheets_CashEruption 1.xlsx` |
| Par sheet SHA-256 | `0213165b827b2008068ed0a33d1101248adfa3722b9930e94be77ecefb5c4642` |
| Model path | `dist/par-sheet-real-games/cash-eruption/model.json` |
